...
<head>
	...
	<title>Cogua - Food - El Barril</title>
...
<body>
	...
	<main>
		<section class="s-pdc">
			<div id="pdf-popup">
				<iframe src="/src/img/restaurantes/el-barril/menu.pdf" frameborder="0" id="pdf-content"></iframe>
					...
					<div class="scc">
						<div class="owl-carousel owl-theme" id="producto-carousel">
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/el-barril/img-1.jfif" alt="">
							</div>
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/el-barril/img-2.jfif" alt="">
							</div>
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/el-barril/img-3.jfif" alt="">
							</div>
			...
			<div class="pd">
				<div id="pd-info">
					<h3>El Barril</h3>
					<span>Hamburguesas, wraps, pechugas, pescados, carnes, costillas, lasagnas, malteadas, bebidas</span>
					<div id="pdi-btn-c">
					...
					<p>
						...
						Correo: <a href="mailto:elbarril@gmail.com">elbarril@gmail.com</a>
					</p>
				</div>
			</div>
		</section>
