...
<head>
	...
	<title>Cogua - Food - Pizzeria Cana</title>
...
<body>
	...
	<main>
		<section class="s-pdc">
			<div id="pdf-popup">
				<iframe src="/src/img/restaurantes/pizzeria-cana/menu.pdf" frameborder="0" id="pdf-content"></iframe>
					...
					<div class="scc">
						<div class="owl-carousel owl-theme" id="producto-carousel">
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/pizzeria-cana/img-1.jfif" alt="">
							</div>
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/pizzeria-cana/img-2.jfif" alt="">
							</div>
			...
			<div class="pd">
				<div id="pd-info">
					<h3>Pizzeria Cana</h3>
					<span>Hamburguesas, lasagnas, malteadas</span>
					<div id="pdi-btn-c">
					...
					<p>
						...
						Correo: <a href="mailto:cana@gmail.com">cana@gmail.com</a>
					</p>
				</div>
			</div>
		</section>
