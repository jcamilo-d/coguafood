...
<head>
	...
	<title>Cogua - Food - Del rancho</title>
	...
	<main>
		<section class="s-pdc">
					...
					<div class="scc">
						<div class="owl-carousel owl-theme" id="producto-carousel">
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/del-rancho/img-1.jfif" alt="">
							</div>
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/del-rancho/img-2.jfif" alt="">
							</div>
			...
			<div class="pd">
				<div id="pd-info">
					<h3>Del rancho</h3>
					<span>Hamburguesas, pechugas, pescados, carnes, costillas, lasagnas, malteadas</span>
					<div id="pdi-btn-c">
					...
					<p>
						...
						Correo: <a href="mailto:delrancho@gmail.com">delrancho@gmail.com</a>
					</p>
				</div>
			</div>
		</section>
