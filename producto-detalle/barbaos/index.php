...
<head>
	...
	<title>Cogua - Food - Barbaos</title>
...
<body>
	...
	<main>
		<section class="s-pdc">
			<div id="pdf-popup">
				<iframe src="/src/img/restaurantes/barbaos/menu.pdf" frameborder="0" id="pdf-content"></iframe>
					...
					<div class="scc">
						<div class="owl-carousel owl-theme" id="producto-carousel">
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/barbaos/img-1.jpg" alt="">
							</div>
			...
			<div class="pd">
				<div id="pd-info">
					...
					<p>
						...
						Correo: <a href="mailto:barbaos@gmail.com">barbaos@gmail.com</a>
					</p>
				</div>
			</div>
		</section>
