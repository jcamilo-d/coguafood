...
<head>
	...
	<title>Cogua - Food - El pino</title>
...
<body>
	...
	<main>
		<section class="s-pdc">
			<div id="pdf-popup">
				<iframe src="/src/img/restaurantes/el-pino/menu.pdf" frameborder="0" id="pdf-content"></iframe>
					...
					<div class="scc">
						<div class="owl-carousel owl-theme" id="producto-carousel">
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/el-pino/img-1.jfif" alt="">
							</div>
							<div class="item-producto">
								<img class="" src="/src/img/restaurantes/el-pino/img-2.jfif" alt="">
							</div>
			...
			<div class="pd">
				<div id="pd-info">
					...
					<p>
						...
						Correo: <a href="mailto:elpino@gmail.com">elpino@gmail.com</a>
					</p>
				</div>
			</div>
		</section>
